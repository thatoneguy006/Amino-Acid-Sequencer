# Analyze codons and create a set of the amino acids!
...
print("Simply enter your codon sequence and press enter to visualize your data!\n")
...
while True:
    ...
    while True:
        user_choice = input(
            "How would you like to visualize your data?\nPlease choose from a Pie Chart, Bar Chart, or Horizontal Bar Chart\n")
